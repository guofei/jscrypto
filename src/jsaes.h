...
extern int counter_encrypt(char *passwd, char *pt, char **result, int len, unsigned char *counter);
extern int counter_decrypt(char *passwd, char *pt, char **result, int len, unsigned char *counter);
