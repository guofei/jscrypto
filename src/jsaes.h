...
extern int counter_encrypt(EVP_CIPHER_CTX *ctx, char *pt, char **result, int len, unsigned char *counter);
extern int counter_decrypt(EVP_CIPHER_CTX *ctx, char *pt, char **result, int len, unsigned char *counter);
